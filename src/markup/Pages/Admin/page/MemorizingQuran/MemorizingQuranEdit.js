                            ...
                            <div className="col-12">
                                ...
                                <div className="card card-plain">
                                    <div className="card-header add">
                                        <h4 className="font-weight-bolder">تعديل الاختيار</h4>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        <label  >اسم الاختيار عربي:</label>
                                                        <input type="text" className="form-control" placeholder="اسم الاختيار" value="30 جزء" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        <label  >اسم الاختيار انجليزي:</label>
                                                        <input type="text" className="form-control" placeholder="اسم الاختيار" value="30 parts" />
                                                    </div>
                                                </div>
