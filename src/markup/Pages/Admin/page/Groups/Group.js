                                ...
                                <div class="card my-4">
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                                            <h6 class="text-white text-capitalize ps-3">مجموعات التصنيفات</h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group input-group-outline">
                                        ...
                                        <Link to="/dashboard/group/groupadd" class="btn bg-gradient-info w-100 mb-0 toast-btn mr-2" >اضافة مجموعة جديدة</Link>
                                    </div>
                                            ...
                                            <table class="table align-items-center mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">اسم المجموعة</th>
                                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">اسم التصنيف التابعة له</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            ...
                                                            <Link to="/dashboard/group/groupedit" class="btn bg-gradient-warning w-100 mb-0 toast-btn" type="button" data-target="warningToast">تعديل</Link>
