...
class SocialSituationsEdit extends Component {
    render() {
        return (
            <>
                <Sidebar />
                            ...
                            <div className="col-12">
                                ...
                                <div className="card card-plain">
                                    <div className="card-header add">
                                        <h4 className="font-weight-bolder">تعديل حالة اجتماعية</h4>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        ...
                                                        <input type="text" className="form-control" placeholder="اسم حالة اجتماعية" value="اهزب" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        <label  >اسم حالة اجتماعية انجليزي:</label>
                                                        <input type="text" className="form-control" placeholder="اسم حالة اجتماعية" value="single" />
                                                    </div>
                                                </div>
...
export default SocialSituationsEdit;