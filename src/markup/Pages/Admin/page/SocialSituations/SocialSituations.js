                            ...
                            <div class="card my-4">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                                        <h6 class="text-white text-capitalize ps-3">حالة اجتماعية</h6>
                                    </div>
                                </div>
                                ...
                                <div class="input-group input-group-outline">
                                    ...
                                    <Link to="/dashboard/socialsituations/socialsituationsadd" class="btn bg-gradient-info w-100 mb-0 toast-btn mr-2" >اضافة حالة اجتماعية جديد</Link>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">اعزب</span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">single
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        ...
                                                        <Link to="/dashboard/socialsituations/socialsituationsedit" class="btn bg-gradient-warning w-100 mb-0 toast-btn" type="button" data-target="warningToast">تعديل</Link>
