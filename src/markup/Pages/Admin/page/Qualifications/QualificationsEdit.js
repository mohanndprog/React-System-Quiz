                            ...
                            <div className="col-12">
                                ...
                                <div className="card card-plain">
                                    <div className="card-header add">
                                        <h4 className="font-weight-bolder">تعديل مؤهل</h4>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        <label  >اسم مؤهل عربي:</label>
                                                        <input type="text" className="form-control" placeholder="اسم مؤهل" value="دبلوم" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        <label  >اسم مؤهل انجليزي:</label>
                                                        <input type="text" className="form-control" placeholder="اسم مؤهل" value="D" />
                                                    </div>
                                                </div>
