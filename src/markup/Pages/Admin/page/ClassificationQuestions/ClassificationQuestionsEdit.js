...
class ClassificationQuestionsEdit extends Component {
    render() {
        return (
            <>
                <Sidebar />
                            ...
                            <div className="col-12">
                                ...
                                <div className="card card-plain">
                                    <div className="card-header add">
                                        <h4 className="font-weight-bolder">تعديل تصنيف الاسئلة</h4>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
                                                        ...
                                                        <input type="text" className="form-control" placeholder="اسم التصنيف" value="احكام شرعية" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group  ">
...
export default ClassificationQuestionsEdit;