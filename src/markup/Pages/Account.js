                            ...
                            <div className="container">
                                ...
                                <div className="col-lg-4 col-md-5 sticky-top asifeaccount">
                                        <ul class="nav nav-pills flex-column mb-auto">
                                            ...
                                            <li>
                                                <Link to={"./account"} class="nav-link link-body-emphasis active">
                                            ...
                                            <li>
                                                <Link to={"./passwordchange"} href="#" class="nav-link link-body-emphasis">
                                                                    ...
                                                                    <div className="row">
                                                                        <div className="col-md-6 ">
                                                                            <div className="form-group">
                                                                                ...
                                                                                <input name="dzName" required="" className="form-control" placeholder="الاسم الاول" type="text" value="Mohand" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-md-6  ">
                                                                            <div className="form-group">
                                                                                <label className="font-weight-700">الاسم الثاني*</label>
                                                                                <input name="dzName" required="" className="form-control" placeholder="الاسم الثاني" type="text" value="Greg" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-md-6  ">
                                                                            <div className="form-group">
                                                                                <label className="font-weight-700">الرقم الوطني*</label>
                                                                                <input name="dzName" required="" className="form-control" placeholder="الرقم الوطني" type="text" value="2323232323" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-md-6  ">
                                                                            <div className="form-group">
                                                                        ...
                                                                        <div className="col-md-6 ">
                                                                            <div className="form-group">
                                                                                ...
                                                                                <input name="dzName" required="" className="form-control" placeholder="رقم الهاتف" type="text" value="2323232323" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-md-6  ">
                                                                            <div className="form-group">
                                                                                <label className="font-weight-700">العنوان*</label>
                                                                                <input name="dzName" required="" className="form-control" placeholder="العنوان" type="text" value="2323232323" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-md-6  ">
                                                                            <div className="form-group">
                                                                        ...
                                                                        <div className="col-md-6  ">
                                                                            <div className="form-group">
                                                                                ...
                                                                                <select className="form-control" aria-label="الحالة الاجتماعية">
                                                                                    ...
                                                                                    <option selected value="1">اعزب</option>
                                                                        ...
                                                                        <div className="col-md-6 ">
                                                                            <div className="form-group">
                                                                                ...
                                                                                <input name="username" required="" className="form-control" placeholder="اسم المستخدم" type="text" value="mohanndprog" />
                                                                            </div>
                                                                        </div>
                                                                        <div className="col-md-6 mt-2 ">
                                                                            <div className="form-group">
                                                                             
                                                                                <Link to={"./passwordchange"} type="submit" className="site-button button-lg radius-no outline outline-2 mt-4">تغيير كلمة المرور</Link>
                                                                            </div>
                                                                        </div>
