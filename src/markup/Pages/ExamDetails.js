                                        ...
                                        <div className="section-full content-inner examsetion">
                                            ...
                                            <div className="container">
                                                ...
                                                <div className="row serv">
                                                    ...
                                                    <div className="col-lg-6 col-md-4 col-sm-6 m-b30">
                                                        <div className="icon-bx-wraper expertise  bx-style-1 p-lr10 p-tb20 center">
                                                            <div className="m-b20">
                                                                <h5 className="dlab-tilte">تاريخ الامتحان</h5>
                                                            </div>
                                                            <div className="icon-content">
                                                                <h5 className="dlab-tilte-bodyexam">
                                                    ...
                                                    <div className="col-lg-6 col-md-4 col-sm-6 m-b30">
                                                        <div className="icon-bx-wraper expertise  bx-style-1 p-lr10 p-tb20 center">
                                                            <div className="m-b20">
                                                                <h5 className="dlab-tilte">مدة الامتحان</h5>
                                                            </div>
                                                            <div className="icon-content">
                                                                <h5 className="dlab-tilte-bodyexam">
                                                                    ساعة واحدة
                                                    ...
                                                    <div className="col-lg-6 col-md-4 col-sm-6 m-b30">
                                                        <div className="icon-bx-wraper expertise  bx-style-1 p-lr10 p-tb20 center">
                                                            <div className="m-b20">
                                                                <h5 className="dlab-tilte">نتيجة الاختبار</h5>
                                                            </div>
                                                            <div className="icon-content">
                                                                <h5 className="dlab-tilte-bodyexam">
                                                                    لم يتم التقديم بعد
                                                    ...
                                                    <div className="col-lg-6 col-md-4 col-sm-6 m-b30">
                                                        <Link to={"./questions"}>
                                                            <div className="icon-bx-wraper examlogin expertise  bx-style-1 p-lr10 p-tb20 center">
                                                                <div className="m-b20">
                                                                    <h5 className="dlab-tilte examlogin">
                                                                        الدخول الى الاختبار
                                                                    </h5>
                                                                </div>
