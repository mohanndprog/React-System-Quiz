            ...
            <>
                ...
                <div className="page-content bg-white">
                    ...
                    <div className="dlab-bnr-inr overlay-primary" style={{ backgroundImage: "url(" + bnr1 + ")" }}>
                        <PageTitle motherMenu='الامتحانات' activeMenu='الامتحانات' />
                    </div>
                            ...
                            <div className="container">
                                ...
                                <div className="col-lg-4 col-md-5 sticky-top asifeaccount">
                                        <ul class="nav nav-pills flex-column mb-auto">
                                            <li class="nav-item">
                                                <Link to={"./exams"} href="#" class="nav-link active" aria-current="page">
                                            ...
                                            <li>
                                                <Link to={"./account"} href="#" class="nav-link link-body-emphasis">
                                                        ...
                                                        <div className="col-lg-4 col-md-4 col-sm-6 m-b30">
                                                            <div className="icon-bx-wraper expertise  bx-style-1 p-lr10 p-tb20 center">
                                                                <div className="icon-bx-sm bg-primary radius m-b20">
                                                                    <Link to={"./examDetails"} className="icon-cell"><svg width="36" height="49" viewBox="0 0 36 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_32_698)">
                                                                            <path d="M30 44.4062C30.825 44.4062 31.5 43.7172 31.5 42.875V15.3125H24C22.3406 15.3125 21 13.9439 21 12.25V4.59375H6C5.175 4.59375 4.5 5.28281 4.5 6.125V42.875C4.5 43.7172 5.175 44.4062 6 44.4062H30ZM0 6.125C0 2.74668 2.69063 0 6 0H21.5156C23.1094 0 24.6375 0.641211 25.7625 1.78965L34.2469 10.4508C35.3719 11.5992 36 13.1592 36 14.7861V42.875C36 46.2533 33.3094 49 30 49H6C2.69063 49 0 46.2533 0 42.875V6.125Z" fill="white" />
                                                                        </g>
                                                                        <defs>
                                                                ...
                                                                <div className="icon-content">
                                                                    <h5 className="dlab-tilte"><Link to={"./examDetails"}>تربية اسلامية</Link></h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ))}
